...
public class BaseBallGameEvent extends Handler implements ActionListener {
   BaseBallGameView bbgv = null;
   BaseBallLogic bbgl = null;
   
   public BaseBallGameEvent(BaseBallGameView bbgv,BaseBallLogic bbl) {
      this.bbgv = bbgv;
      this.bbgl = bbl;
   }
